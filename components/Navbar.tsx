...
const Navbar = () => {
    ...
    return (
        <header className="navigation z-50 relative flex items-center top-2 justify-between w-full px-16 pt-4 pb-8" x-data={"expanded:false"}>
            {/* LOGO */}
            ...
            {/* NAVBAR */}
            <div className=" xl:w-fit backdrop-blur-3xl bg-[#4C1D95] rounded-lg shadow-2xl px-4 border-white max-w-7xl  ">
                <nav className="flex  items-center justify-between h-auto top-8 lg:h-16 ">
                    ...
                    <div className="hidden lg:flex lg:items-center lg:ml-auto lg:space-x-10">
                        <Link href="/" title="" className="text-xl font-normal text-gray-100 transition-all duration-200 hover:text-violet-500 focus:text-violet-500 hover:-mt-1"> Home </Link>
                ...
                <nav className={`lg:hidden bg-violet-500 ${expanded ? 'block' : 'hidden'}`}>
                    <div className="flow-root">
                        <div className="flex flex-col px-6 -my-2 space-y-1">
                            ...
                            <Link href="/profile" title="" className="inline-flex py-2 text-base font-medium text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Profile </Link>

                            <Link href="/projects" title="" className="inline-flex py-2 text-base font-medium text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Projects </Link>

                            <Link href="/contact" title="" className="inline-flex py-2 text-base font-medium text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Contact </Link>
                        </div>
                    </div>
